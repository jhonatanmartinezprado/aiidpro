...
export default function Footer() {
  return (
    <div className="flex flex-col justify-center items-center pt-10 pb-8 bg-backColor text-pippons">
      ...
      <div className="flex gap-5 justify-center px-5 mt-8 text-sm tracking-normal leading-5 text-center text-stone-500 font-semibold">
